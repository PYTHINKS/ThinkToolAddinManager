...
public class LogControlViewModel : ViewModelBase
{
    ...
    public string OutputHintText => "Trace and debug output";
    public string ClearText => "Clear";
    public string ClearOutputTooltip => "Clear all output";
    public string CopyText => "Copy";

    public void RefreshLocalizedText()
    {
        OnPropertyChanged(nameof(OutputHintText));
        OnPropertyChanged(nameof(ClearText));
        OnPropertyChanged(nameof(ClearOutputTooltip));
