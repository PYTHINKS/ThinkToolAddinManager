...
using ThinkToolAddinManager.ViewModel;
...
public sealed class ThinkToolManagerBase
{
...
// #else
    ...
    public static ThinkToolManagerBase Instance
    {
        get
        {
            if (_instance == null)
...
#pragma warning disable RCS1059 // Avoid locking on publicly accessible instance.
                lock (typeof(ThinkToolManagerBase))
                {
                    if (_instance == null)
                    {
                        _instance = new ThinkToolManagerBase();
                    }
                }
#pragma warning restore RCS1059 // Avoid locking on publicly accessible instance.
    ...
    private ThinkToolManagerBase()
    {
        _addinManager = new ThinkToolAddinManager.ViewModel.ThinkToolManager();
        _activeCmd = null;
        _activeCmdItem = null;
        _activeLisp = null;
    ...
    public ThinkToolAddinManager.ViewModel.ThinkToolManager ThinkToolManager
    {
        get => _addinManager;
    ...
    private static volatile ThinkToolManagerBase _instance;
    ...
    private ThinkToolAddinManager.ViewModel.ThinkToolManager _addinManager;
}
